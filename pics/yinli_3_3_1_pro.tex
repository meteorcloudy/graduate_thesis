...
\node[edge label,xshift=-2mm,below=25mm] at (1) {$R_{ab} \prec R_{ac}$};
...
\node[edge label,above left = 0mm and 0 mm of 2] {\scriptsize{$R_{ab}$}};
\node[edge label,above left = 0mm and 0 mm of 1] {\scriptsize{$R_{ac}$}};
\end{tikzpicture}
~~~~~~~~~~
\begin{tikzpicture}[-,>=stealth', 
level 1/.style={sibling distance = 10mm},
...
;
\node[edge label,xshift=-2mm,below=25mm] at (1) {$R_{bc} \prec R_{ac}$};
\draw[gray] (0.25,-0.5) -- (0.09,-0.82);
\draw[gray] (-0.25,-0.5) -- (-0.09,-0.82);
% \draw[gray] (-0.25,-1.5) -- (-0.41,-1.82);
\draw[gray] (-0.75,-1.5) -- (-0.59,-1.82);
\draw[dashed] (0,0) -- (0.5,0.35);   
\node[edge label,above left = 0mm and 0 mm of 2] {\scriptsize{$R_{bc}$}};
\node[edge label,above left = 0mm and 0 mm of 1] {\scriptsize{$R_{ac}$}};
\end{tikzpicture}
