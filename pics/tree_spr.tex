...
\node (0) {}
    ...
    child{
        [sibling distance = 10mm] node (4) {}
            child[dashed]{
                node (5) {}
                child[solid]{ node[main node] (7) {$c$}}
                child[solid]{ node[main node] (8) {$e$}}
            }
            child{
                node [main node] (6) {$d$}
            }
...
\node [edge label, xshift = 0mm, below=35mm, align=flush center] at (0){
        \scriptsize{$T_1$}};
...
\begin{tikzpicture}[->]
\node[edge label] (0) {};
\node [edge label, above=12mm, align=flush center] (a) at (0){};
\node [edge label, xshift = 5mm, above=12mm, align=flush center] (b) at (0){};
        ...
        [sibling distance = 15mm] node (1) {}
            child{
                [sibling distance = 10mm] node (2) {}
                    ...
                    child{
                        node (5) {}
                        child{ node[main node] (7) {$c$}}
                        child{ node[main node] (8) {$e$}}
                    }
            }
...
;
\node [edge label, xshift = -6mm, below=45mm, align=flush center] at (0){
        \scriptsize{$T_2$}};
